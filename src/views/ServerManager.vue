...
const formDefaults = { name: '', type: '', ip: '', location: '', os: '', purpose: '', project: '' }
...
// 编辑服务器
function editServer(row: any) { editRow(row, form, editRowId, dialogVisible) }
// 保存（新增/编辑）
function saveServer() { save(serverApi, form, editRowId, closeDialogHandler, getServers) }
// 批量删除
